...
";
    ...
    <div class=\"container pc-view\">
        <div>
            ...
            <ul>
                <li>
                    <p>
                        Групповые занятия (не больше 5 человек) &mdash; 1.5 часа, два-три раза в неделю, цена от ";
        // line 68
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["prices"]) ? $context["prices"] : $this->getContext($context, "prices")), "group", array()), "cost", array()), "html", null, true);
        echo " ";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["prices"]) ? $context["prices"] : $this->getContext($context, "prices")), "group", array()), "currency", array()), "html", null, true);
        echo " за занятие.
                    </p>
                </li>
                <li>
                    <p>
                        Индивидуальное занятие - 1 час, два-три раза в неделю, цена от 150 грн.
                    </p>
                    <p>
    ...
    <div class=\"mobile-view container main-block\">
        ...
        <div>
            ...
            <ul>
                <li>Индивидуальное занятие - 1 час, два-три раза в неделю, цена от 150 грн.</li>
                <li>Групповые занятия(не больше 5 человек) - 1.5 часа, два-три раза в неделю, цена от ";
        // line 323
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["prices"]) ? $context["prices"] : $this->getContext($context, "prices")), "group", array()), "html", null, true);
        echo ".</li>
            </ul>
...
";
    ...
    {
        return array (  484 => 380,  482 => 379,  470 => 370,  462 => 365,  454 => 360,  446 => 355,  438 => 350,  428 => 343,  424 => 342,  418 => 341,  408 => 334,  402 => 331,  391 => 323,  340 => 275,  336 => 274,  325 => 268,  183 => 129,  177 => 126,  167 => 121,  130 => 86,  128 => 85,  106 => 68,  51 => 15,  48 => 14,  46 => 13,  42 => 11,  39 => 10,  32 => 5,  29 => 4,  11 => 1,);
    }
}
...
/*                 <li>*/
/*                     <p>*/
/*                         Групповые занятия (не больше 5 человек) &mdash; 1.5 часа, два-три раза в неделю, цена от {{ prices.group.cost }} {{ prices.group.currency }} за занятие.*/
/*                     </p>*/
/*                 </li>*/
/*                 <li>*/
/*                     <p>*/
...
/*             <ul>*/
/*                 <li>Индивидуальное занятие - 1 час, два-три раза в неделю, цена от 150 грн.</li>*/
/*                 <li>Групповые занятия(не больше 5 человек) - 1.5 часа, два-три раза в неделю, цена от {{ prices.group }}.</li>*/
/*             </ul>*/
/*             <p>Для детей цены ниже</p>*/
/* */
/*             <p class="text-center">*/
